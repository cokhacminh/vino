...
<div class="thread-container">
    ...
    <div class="thread-list" id="threadList">
        ...
        <div class="empty-state">
            ...
            <p>Chưa có bài viết góp ý nào. Hãy tạo bài viết đầu tiên!</p>
        </div>
        @endforelse
    </div>
</div>
...
<div class="modal-overlay" id="modalCreate">
    <div class="modal-box" style="width: 700px;">
        <div class="modal-header">
            <h3>✍️ Tạo Bài Viết Góp Ý</h3>
            <button class="modal-close" onclick="closeModal('modalCreate')">✕</button>
        </div>
        <div class="modal-body">
            <form method="POST" action="{{ route('system.gopY.store') }}" enctype="multipart/form-data" id="formCreate" onsubmit="return handleCreateSubmit(this)">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="body" id="threadBody" rows="8" required placeholder="Mô tả chi tiết góp ý của bạn..."></textarea>
                </div>
                <div class="form-group">
...
<script>
    ...
    function startCommentPolling() {
        ...
        commentPollTimer = setInterval(() => {
            ...
            fetch('/system/gop-y/' + currentThreadId, { headers: { 'Accept': 'application/json' } })
                .then(r => r.json())
                .then(data => {
    ...
    function viewThread(id) {
        currentThreadId = id;
        fetch('/system/gop-y/' + id, { headers: { 'Accept': 'application/json' } })
            .then(r => r.json())
            .then(data => {
    ...
    function submitReply(parentId) {
        ...
        fetch('/system/gop-y/' + currentThreadId + '/comment', {
            method: 'POST',
