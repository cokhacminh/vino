...
<div class="gallery-container">
    ...
    <div class="gallery-header">
        <div class="gallery-title">
            <i class="fas fa-camera-retro"></i> Album Kỉ Niệm
        </div>
    </div>
...
async function loadGallery(folder) {
    ...
    try {
        const resp = await fetch("{{ route('media.memoryGalleryApi') }}?folder=" + encodeURIComponent(folder));
