...
<div class="gallery-container">
    ...
    <div class="gallery-header">
        ...
        <div class="gallery-title">
            ...
            <i class="fas fa-camera-retro"></i> MiDo Farm
...
async function loadGallery(folder) {
    ...
    try {
        ...
        const resp = await fetch("{{ route('media.farmGalleryApi') }}?folder=" + encodeURIComponent(folder));
        ...
        if (data.folders.length > 0) {
            ...
            data.folders.forEach(f => {
                ...
                const fullAlbumPath = currentFolder ? 'Farm Tôm/' + currentFolder + '/' + f.name : 'Farm Tôm/' + f.name;
